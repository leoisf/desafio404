...
MapTo('desafio404/components/download')(DownloadV1, {isEmpty: DownloadV1IsEmptyFn});
MapTo('desafio404/components/list')(ListV2, {isEmpty: ListV2IsEmptyFn});
MapTo('desafio404/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});

MapTo('desafio404/components/button')(ButtonV1, {isEmpty: ButtonV1IsEmptyFn});
MapTo('desafio404/components/teaser')(TeaserV1, {isEmpty: TeaserV1IsEmptyFn});
MapTo('desafio404/components/image')(ImageV2, {isEmpty: ImageV2IsEmptyFn});
...
MapTo('desafio404/components/navigation')(NavigationV1);
MapTo('desafio404/components/languagenavigation')(LanguageNavigationV1);


MapTo('desafio404/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
MapTo('desafio404/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
MapTo('desafio404/components/carousel')(CarouselV1, {isEmpty: CarouselV1IsEmptyFn});
MapTo('desafio404/components/container')(ContainerV1, {isEmpty: ContainerV1IsEmptyFn});
...
MapTo('desafio404/components/text')(LazyTextComponent, TextEditConfig);